...
```
pacman -S mingw-w64-ucrt-x86_64-{vtk,itk,muparser,armadillo,cmake-gui,gcc,gcc-fortran,qt6,cli11,openvr,anari-sdk,boost,seacas,adios2,gl2ps,proj,openslide,eigen3,utf8cpp,exprtk,nlohmann-json,gtest,wxwidgets3.2,git-gui,graphviz,doxygen,ntldd}
```
3. Python
```bash
